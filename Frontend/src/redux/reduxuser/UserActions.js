...
const registerFailure = error => {
  ...
  export const registerAction = (obj) => {
    return (dispatch)=>  {
      ...
      axios
        .post('http://localhost:8082/login/addUser',obj)
        .then(response => {
...
export const loginAction = (userName,Password) => {
  return (dispatch)=>  {
    ...
    axios
      .get(`http://localhost:8082/login/${userName}/${Password}`)
      .then(response => {
        // response.data is the users
 ...
 const updateUserFailure = error => {
  ...
  export const updateUserAction = (id,obj) => {
    return (dispatch)=>  {
      ...
      axios
        .put(`http://localhost:8082/login/${id}`,obj)
        .then(response => {
          // response.data is the users
...
export const deleteUserAction = (id) => {
  return (dispatch)=>  {
    ...
    axios
      .delete(`http://localhost:8082/login/${id}`)
      .then(response => {
        // response.data is the users
