                                        ...
                                        <form id='form' class="mx-1 mx-md-4">
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input name="username" type="text" id="form3Example1c" class="form-control" onInput={formValidate} value={SgUForm.userName}  onChange={e => setSgUForm({...SgUForm,userName : e.target.value})}/>
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input name="usertype" type="email" id="form3Example3c" class="form-control" onInput={formValidate} value={SgUForm.userRole}  onChange={e => setSgUForm({...SgUForm,userRole : e.target.value})}/>
                                                    <label class="form-label" for="form3Example3c">Your Role</label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    <input name="password" type="password" id="form3Example4c" class="form-control" onInput={formValidate} value={SgUForm.password}  onChange={e => setSgUForm({...SgUForm,password : e.target.value})}/>
...
<div className="row btn-group">
  ...
  <div className="text-warning">
    ...
    <p id="error1" style={{backgroundColor:""}}></p>
                                            ...
                                            <Link to="/signupactions" id="formregister"   style={{pointerEvents:"none",color:"black"}}  class="btn btn-primary btn-lg" >Register</Link>
                                            </div>
