...
import com.ops.in.entities.Cart;
...
//	@Override
//    public Double getTotalAmount(String name) {
//		
//		Map<Product,Integer>items= 
//        List<Product> cartItems = viewProductListByCategoryName(name) ;
//        Double totalAmount = new Double(0.00);
////        for (Product ci : cartItems) {
////            totalAmount = totalAmount.add(ci.getProducts().getPrice().multiply(new BigDecimal(ci.getQuantity())));
////        }
//        
//        return totalAmount;
    //}
