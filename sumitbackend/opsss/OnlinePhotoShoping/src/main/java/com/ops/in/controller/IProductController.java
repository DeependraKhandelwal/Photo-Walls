...
//    }
	...
	public ResponseEntity<Boolean> removeProduct(@PathVariable Integer productId) throws CategorycNotfoundException {
		
		try {
			productService.removeProduct(productId);
			logger.info("Record Deleted with Id : " + productId);
			return new ResponseEntity<>(true,HttpStatus.OK);
		} catch (Exception e) {
			logger.error("Record NOT Deleted with Id : " + productId);
